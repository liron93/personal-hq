...
--   partner_full_finance       = אפשרות B: בית חדש + כל הכספים כולל תנועות וייבוא, קריאה בלבד
--   partner_full_finance_edit  = B+ (ההחלטה של לירון, 21.9.2026, ברירת המחדל לליאור): B וגם עריכת תקציב ותנועות
