...
/** חבילות הענקה. A = partner_budget_view (ברירת מחדל), A+ = partner_budget_edit, B = partner_full_finance. */
export const ROLE_TEMPLATES = Object.freeze({
  partner_budget_view: BUDGET_VIEW,
  partner_budget_edit: [...BUDGET_VIEW, "finance.dashboard_budget.write"],
  partner_full_finance: [...BUDGET_VIEW, "finance.dashboard_budget.write", "finance.transactions.read", "finance.transactions.write"],
  designer_beit_hadash: ["company.beit-hadash.read", "company.beit-hadash.write"],
});

export const DEFAULT_PARTNER_TEMPLATE = "partner_budget_view";
