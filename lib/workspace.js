...
import {
  CAPABILITIES, COMPANY_STATE_CAPABILITIES, canAccessStateKey, canViewHq, visibleSharedCompanies,
 ...
 *  member owner: הכול. member רגיל: חברות משותפות לפי יכולת קריאה, ואת הקריירה האישית (הריקה) שלו רק אם יש לו hq.view
 *  (שותף, לא מעצבת). בריאות ונפשי אף פעם (החלטת מוצר, docs/rbac/DESIGN.md).
