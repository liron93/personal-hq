...
export default function MemberHome({ access, refresh }) {
  ...
  return <main style={{ maxWidth: 560, margin: "0 auto", padding: "48px 20px", direction: "rtl" }}>
    ...
    {list.length === 0
      ? (access?.reason === "unavailable"
        ? <p style={{ opacity: 0.7 }}>לא ניתן לאמת הרשאות כרגע. בדקו חיבור, הבדיקה תיעשה שוב אוטומטית. <button onClick={refresh} style={{ border: 0, background: "transparent", color: "#4059AD", cursor: "pointer" }}>נסו שוב עכשיו</button></p>
