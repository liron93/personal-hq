...
export default function WellbeingAppV4() {
  ...
  return <main className={css.shell} dir="rtl">
    ...
    {tab==="support"&&<section className={css.stack}>
      <div className={css.hero soft}><p>לא צריך לעבור הכול לבד</p><h2>רשת התמיכה שלי</h2><span>שמות והערות פרטיים. שום הודעה לא נשלחת מכאן.</span></div>
