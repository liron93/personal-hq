...
// טקסט משקל לתרגיל בעברית: "טרם נקבע", "70 ק״ג", או "70 / 70 / טרם נקבע".
...
// טווח: 8-12 או 12. משקל: מספר (לכל הסטים), או רשימה מופרדת ב-/ באורך מספר הסטים (70/70/60, או 23.75/21.25/טרם נקבע);
